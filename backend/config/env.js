...
const env = {
  ...
  TUTOR_PROVIDER: (process.env.TUTOR_PROVIDER || (boolEnv('NOESIS_DEMO_MODE', false) && process.env.GROQ_API_KEY ? 'groq' : (process.env.AI_PROVIDER || 'ollama'))).toLowerCase(),
  TUTOR_STRICT_QUALITY: boolEnv('TUTOR_STRICT_QUALITY', boolEnv('NOESIS_DEMO_MODE', false)),
  ...
  NOESIS_DEMO_MODE: boolEnv('NOESIS_DEMO_MODE', false),

...
const th = {
  ...
  hero: { display: 'grid', gridTemplateColumns: '76px 1fr', gap: 18, alignItems: 'center', marginBottom: 24 },
  avatar: {
  ...
  kicker: { fontSize: 11, letterSpacing: '0.12em', color: 'var(--fg-3)', textTransform: 'uppercase', marginBottom: 6 },
  title: { margin: 0, fontFamily: 'var(--font-display)', fontSize: 'clamp(34px, 5vw, 58px)', fontWeight: 300, letterSpacing: 0 },
  copy: { margin: '10px 0 0', maxWidth: 680, color: 'var(--fg-2)', fontSize: 15, lineHeight: 1.7 },
  continueButton: {
    marginTop: 16,
    display: 'inline-flex',
    alignItems: 'center',
  ...
  card: {
    minHeight: 260, padding: 22, textAlign: 'left', borderRadius: 'var(--r-md)',
  ...
  cardTitle: { fontFamily: 'var(--font-display)', fontSize: 26, color: 'var(--fg-0)' },
  cardDesc: { color: 'var(--fg-2)', fontSize: 13.5, lineHeight: 1.65, maxWidth: 420 },
  cardAction: { marginTop: 'auto', display: 'flex', alignItems: 'center', gap: 6, color: 'var(--accent)', fontSize: 12.5, fontWeight: 600 },
  recentPanel: { marginTop: 18, border: '1px solid var(--line)', borderRadius: 'var(--r-md)', background: 'var(--bg-1)', overflow: 'hidden' },
  recentHeader: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 12, padding: 16, borderBottom: '1px solid var(--line)' },
  recentTitle: { fontFamily: 'var(--font-display)', fontSize: 22, color: 'var(--fg-0)' },
  ...
  recentItemTitle: { color: 'var(--fg-0)', fontSize: 13.5, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' },
  recentItemMeta: { color: 'var(--fg-3)', fontSize: 12, marginTop: 3, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' },
  recentTime: { color: 'var(--fg-3)', fontSize: 11.5, whiteSpace: 'nowrap' },
  recentEmpty: { padding: 16, color: 'var(--fg-3)', fontSize: 12.5, lineHeight: 1.6 },
};

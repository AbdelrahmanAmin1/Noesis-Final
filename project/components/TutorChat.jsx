...
const tc = {
  ...
  contextMeta: { display: 'flex', alignItems: 'center', gap: 10 },
  kicker: { fontSize: 10.5, letterSpacing: '0.1em', textTransform: 'uppercase', color: 'var(--fg-3)', marginBottom: 3 },
  materialSelect: { width: 280, maxWidth: '48vw', fontSize: 12.5, padding: '8px 10px' },
  contextHint: { color: 'var(--fg-2)', fontSize: 12.5, minWidth: 0, flex: 1, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' },
  ...
  avatarTitle: { fontFamily: 'var(--font-display)', fontSize: 18, color: 'var(--fg-0)', lineHeight: 1.2 },
  avatarStatus: { color: 'var(--fg-2)', fontSize: 12.5, lineHeight: 1.45, marginTop: 3 },
  messages: { flex: 1, overflow: 'auto', padding: '24px clamp(18px, 4vw, 56px)', display: 'flex', flexDirection: 'column', gap: 14 },
  emptyState: { minHeight: 430, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', gap: 14 },
  avatarLarge: {
  ...
  emptyTitle: { margin: 0, fontFamily: 'var(--font-display)', fontSize: 36, fontWeight: 300, color: 'var(--fg-0)' },
  emptyText: { margin: 0, maxWidth: 560, color: 'var(--fg-2)', fontSize: 14, lineHeight: 1.7 },
  emptySourcePanel: {
    display: 'flex',
    alignItems: 'center',
    gap: 8,
  ...
  emptySourceLabel: { color: 'var(--fg-3)', fontSize: 11, textTransform: 'uppercase', letterSpacing: '0.08em', whiteSpace: 'nowrap' },
  emptySourceSelect: { minWidth: 260, maxWidth: '62vw', fontSize: 12.5, padding: '8px 10px' },
  sampleGrid: { display: 'flex', gap: 8, flexWrap: 'wrap', justifyContent: 'center', marginTop: 8, maxWidth: 760 },
  sampleChip: { padding: '9px 12px', borderRadius: 999, border: '1px solid var(--line)', background: 'var(--bg-1)', color: 'var(--fg-1)', fontSize: 12.5 },
  ...
  bubbleAvatar: {
    ...
    background: 'var(--accent-glow)', border: '1px solid var(--accent-soft)', color: 'var(--accent)', flexShrink: 0, marginTop: 3,
  },
  ...
  bubbleMeta: { display: 'flex', alignItems: 'center', gap: 6, fontSize: 10.5, letterSpacing: '0.08em', textTransform: 'uppercase', color: 'inherit', opacity: 0.78, marginBottom: 5 },
  messageTime: { letterSpacing: 0, textTransform: 'none', color: 'var(--fg-3)', fontSize: 10.5 },
  ...
  suggestions: { display: 'flex', gap: 8, overflowX: 'auto', padding: '8px clamp(18px, 4vw, 56px) 0' },
  suggestionChip: { padding: '8px 11px', borderRadius: 999, background: 'var(--bg-2)', border: '1px solid var(--line)', color: 'var(--fg-1)', fontSize: 12 },
  actionChips: { display: 'flex', gap: 8, overflowX: 'auto', padding: '10px clamp(18px, 4vw, 56px) 0', borderTop: '1px solid var(--line)' },
  actionChip: {
    display: 'inline-flex',
    alignItems: 'center',
    gap: 6,
  ...
  actionResult: { marginTop: 12, padding: 12, borderRadius: 8, background: 'var(--bg-2)', border: '1px solid var(--line)' },
  ...
  textarea: {
    ...
    color: 'var(--fg-0)', fontSize: 13.5, lineHeight: 1.5, minHeight: 36, maxHeight: 140, padding: '8px 4px',
  },
  sendButton: { minHeight: 36 },
  error: { marginBottom: 8, color: 'var(--err)', fontSize: 12.5 },
  speechHint: { marginBottom: 8, color: 'var(--warn)', fontSize: 12.5 },
  ...
  railHeader: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 10, padding: 16, borderBottom: '1px solid var(--line)' },
  railTitle: { fontFamily: 'var(--font-display)', fontSize: 20, color: 'var(--fg-0)' },
  railBody: { height: 'calc(100vh - 143px)', overflow: 'auto', padding: 16 },
  badge: { padding: '4px 7px', borderRadius: 999, border: '1px solid var(--line)', fontSize: 10.5, whiteSpace: 'nowrap' },
  emptyRail: { color: 'var(--fg-3)', fontSize: 12.5, lineHeight: 1.6, padding: 12, border: '1px dashed var(--line)', borderRadius: 8 },
  sourceCard: { padding: 12, border: '1px solid var(--line)', borderRadius: 8, background: 'var(--bg-1)', marginBottom: 12 },
  sourceCardActive: { borderColor: 'var(--accent)', boxShadow: '0 0 0 3px var(--accent-glow)' },
  sourceTopline: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 8, marginBottom: 5 },
  sourceKicker: { fontSize: 10.5, color: 'var(--accent)', letterSpacing: '0.08em', textTransform: 'uppercase', marginBottom: 5 },
  sourceScore: { fontSize: 10.5, color: 'var(--fg-3)', fontVariantNumeric: 'tabular-nums' },
  sourceTitle: { fontSize: 12.5, color: 'var(--fg-0)', marginBottom: 6, fontWeight: 600 },
  sourceExcerpt: { color: 'var(--fg-2)', fontSize: 12.2, lineHeight: 1.55 },
  scoreBar: { marginTop: 10, height: 4, background: 'var(--bg-2)', borderRadius: 999, overflow: 'hidden' },
  scoreFill: { display: 'block', height: '100%', background: 'var(--accent)' },
  sourceLink: { marginTop: 10, padding: 0, border: 0, background: 'transparent', color: 'var(--accent)', fontSize: 11.5, cursor: 'pointer' },
  traceBox: { marginTop: 14, padding: 12, border: '1px solid var(--line)', borderRadius: 8, background: 'var(--bg-1)' },
  tracePair: { display: 'flex', justifyContent: 'space-between', gap: 10, padding: '6px 0', color: 'var(--fg-2)', fontSize: 12 },
  ...
  typingBubble: { display: 'inline-flex', alignItems: 'center', gap: 9, width: 'auto' },
  typingLabel: { color: 'var(--fg-2)', fontSize: 12.5 },
  typingDots: { display: 'inline-flex', alignItems: 'center', gap: 3 },
};
